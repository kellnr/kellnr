...
async fn get_crate_overview_list() {
    ...
    let overview_list = test_db.get_crate_overview_list(10, 0).await.unwrap();
...
async fn test_get_total_cached_downloads_works() {
    test_db.test_add_cached_crate_with_downloads(
        "my_crate",
        "1.0.0",
        10
    )

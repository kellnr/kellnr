<template>
  ...
  <div id="statistics">
    <div id="statisticsCards" v-if="statistics">
      <!-- Hosted crates statistics -->
      <statistics-card :num="statistics.num_crates" :icon="'fa-boxes'" :text="'Crates'"></statistics-card>
      <statistics-card :num="statistics.num_crate_versions" :icon="'fa-code-branch'"
        :text="'Versions'"></statistics-card>
      ...
      <statistics-card v-if="statistics.last_updated_crate" :num="statistics.last_updated_crate[0]"
        :icon="'fa-calendar'" :text="'Last Updated ' + statistics.last_updated_crate[1]"></statistics-card>
      ...
      <statistics-card v-if="statistics.proxy_enabled" :num="statistics.num_proxy_crate_versions"
        :icon="'fa-code-branch'" :text="'Cached Versions'"></statistics-card>

<template>
  ...
  <p id="intro">
    Values are set on application startup. See <a href="https://kellnr.io/documentation" class="link">Kellnr
      Configuration Documentation</a> for more information.
  </p>

  <h3 class="k-h3">Registry</h3>
  <div>
    <startup-config-item toml="[registry] data_dir" env="KELLNR_REGISTRY__DATA_DIR"
      :value="settings.registry.data_dir"></startup-config-item>
    <startup-config-item toml="[registry] session_age_seconds" env="KELLNR_REGISTRY__SESSION_AGE_SECONDS"
      :value="settings.registry.session_age_seconds"></startup-config-item>
    <startup-config-item toml="[registry] cache_size" env="KELLNR_REGISTRY__CACHE_SIZE"
      :value="settings.registry.cache_size"></startup-config-item>
  <startup-config-item toml="[registry] max_crate_size" env="KELLNR_REGISTRY__MAX_CRATE_SIZE"
    :value="settings.registry.max_crate_size"></startup-config-item>
    <startup-config-item toml="[registry] auth_required" env="KELLNR_REGISTRY__AUTH_REQUIRED"
  ...
  <startup-config-item toml="api_address" env="KELLNR_API_ADDRESS"

<template>
  <h2 class="k-h2">Repair crates.io Index</h2>
    <p class="k-p">
      If the <i>crates.io</i> index, used by the cache, is out of sync and cannot repair itself, this button triggers a re-creation of the index. This can take several minutes, in which no <i>crates</i> from the <i>crates.io</i> proxy can be served.

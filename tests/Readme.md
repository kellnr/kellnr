...
**115 UI tests across 19 test files:**
...
| `ui-oauth2.spec.ts` | 14 | OAuth2 login/logout, auto-provisioning, sessions, SSO enforcement |
...
| `ui-user-management.spec.ts` | 9 | User management, admin promotion/demotion, settings tabs |

`src/cli.spec.ts` adds 16 non-UI tests for the `kellnr` command line interface. They run in
